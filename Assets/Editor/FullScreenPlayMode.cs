...
namespace FullScreenPlayModes
{
    ...
    public class FullScreenPlayMode : Editor
    {
        ...
        private static int osBorder = 6;
        private static int horizontalAdjustment = -1;
            ...
            if (PlayerPrefs.GetInt("PlayMode_FullScreen", 0) == 1)
            {
                ...
                switch (_playModeStateChange)
                {
                    case PlayModeStateChange.EnteredPlayMode:
                        ...
                        Rect newPos = new Rect(0 + horizontalAdjustment, 0 - toolbarHeight, Screen.currentResolution.width - horizontalAdjustment * 2, Screen.currentResolution.height + toolbarHeight + osBorder);

                        gameView.position = newPos;
                        gameView.minSize = new Vector2(Screen.currentResolution.width - horizontalAdjustment * 2, Screen.currentResolution.height + toolbarHeight + osBorder);
